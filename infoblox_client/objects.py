...
class DiscoverySdnconfig(SubObjects):
    _fields = ['addresses', 'api_key', 'ca_certificate', 'comment', 'handle',
...
class Admingroup(InfobloxObject):
    ...
    access_method: Access methods specify whether an admin group can use
        ...
        API and RESTful API.
    admin_set_commands: Admin set commands for the admin command group.
    ...
    admin_toplevel_commands: Admin_toplevel commands for the admin
        command group
    cloud_set_commands: Cloud set commands for the cloud command group.
    comment: Comment for the Admin Group; maximum 256 characters.
    database_set_commands: Database set commands for database admin
        group.
    ...
    dhcp_show_commands: Dhcp show commands for the dhcp command group.
    ...
    docker_set_commands: Docker set commands for the dcoker command
        group.
    docker_show_commands: Docker show commands for the dcoker command
        group.
    ...
    lockout_setting: This struct specifies security policy settings in
        admin group.
    machine_control_toplevel_commands: Machine control toplevel commands
        for the machine control command group.
    name: The name of the Admin Group.
    networking_set_commands: Set commands for the networking command
        group.
    networking_show_commands: Show commands for the networking command
        group.
    ...
    security_set_commands: Set commands for the security command group.
    ...
    _fields = ['access_method', 'admin_set_commands', 'admin_show_commands',
               'admin_toplevel_commands', 'cloud_set_commands', 'comment',
               'database_set_commands', 'database_show_commands',
               'dhcp_set_commands', 'dhcp_show_commands', 'disable',
               'disable_concurrent_login', 'dns_set_commands',
               'dns_show_commands', 'dns_toplevel_commands',
               'docker_set_commands', 'docker_show_commands',
               'email_addresses', 'enable_restricted_user_access', 'extattrs',
...
class DiscoveryGridproperties(InfobloxObject):
    ...
    advanced_sdn_polling_settings: Discovery advanced polling settings.
...
class DiscoverySdnnetwork(InfobloxObject):
    ...
    Fields:
    first_seen: Timestamp when this SDN network was first discovered.
    name: The name of the SDN network.
    network_view: The name of the network view assigned to this SDN
        network.
    source_sdn_config: Name of SDN configuration this network belongs
        to.
    """
...
class DiscoveryStatus(InfobloxObject):
    ...
    sdn_collection_enabled: Indicate whether SDN collection enabled for
        the device.
...
class FixedAddressV4(FixedAddress):
    ...
    restart_if_needed: Restarts the member service. The
        restart_if_needed flag can trigger a restart on DHCP services
        only when it is enabled on CP member.
...
class GridThreatanalytics(InfobloxObject):
    ...
    Fields:
    configure_domain_collapsing: Disable domain collapsing at grid level
    ...
    enable_whitelist_auto_download: Indicates whether auto download
        service is enabled
    enable_whitelist_scheduled_download: Indicates whether the custom
        scheduled settings for auto download is enabled. If false then
        default frequency is once per 24 hours
...
class Member(InfobloxObject):
    ...
    _fields = ['active_position', 'additional_ip_list',
               ...
               'config_addr_type', 'csp_member_setting',
...
class MemberDns(InfobloxObject):
    ...
    _fields = ['add_client_ip_mac_options', 'additional_ip_list',
               ...
               'atc_fwd_forward_first', 'attack_mitigation', 'auto_blackhole',
               ...
               'use_mgmt_ipv6_port', 'use_mgmt_port', 'use_notify_delay',
               'use_nxdomain_redirect', 'use_record_name_policy',
               'use_recursive_client_limit', 'use_recursive_query_setting',
               'use_resolver_query_timeout', 'use_response_rate_limiting',
               'use_root_name_server', 'use_rpz_disable_nsdname_nsip',
...
class Msserver(InfobloxObject):
    ...
    connection_status: Result of the last RPC connection attempt made
    connection_status_detail: Detail of the last connection attempt made
    dhcp_server: RW fields needed for DHCP purposes at Microsoft Server
        level
    ...
    log_destination: Directs logging of sync messages either to syslog
        or mslog
    log_level: Log level for this Microsoft Server
    login_name: Microsoft Server login name, with optional domainname
    ...
    ms_rpc_timeout_in_seconds: Timeout in seconds of RPC connections for
        this MS Server
    ...
    use_log_destination: Override log_destination inherited from grid
        level
    use_ms_max_connection: Override grid ms_max_connection setting
    use_ms_rpc_timeout_in_seconds: Flag to override cluster RPC timeout
...
class MsserverDhcp(InfobloxObject):
    ...
    next_sync_control: Defines what control to apply on the DHCP server
...
class ParentalcontrolSubscribersite(InfobloxObject):
    ...
    _fields = ['abss', 'block_size', 'blocking_ipv4_vip1',
               ...
               'blocking_ipv6_vip2', 'comment', 'extattrs', 'first_port',
               'maximum_subscribers', 'members', 'msps', 'name',
               'nas_gateways', 'nas_port', 'spms', 'strict_nat']
    _search_for_update_fields = ['name']
    ...
    _all_searchable_fields = ['blocking_ipv4_vip1', 'blocking_ipv4_vip2',
                              'blocking_ipv6_vip1', 'blocking_ipv6_vip2',
                              'comment', 'name']
    _return_fields = ['block_size', 'extattrs', 'first_port', 'name',
                      'strict_nat']
    _remap = {}
    _shadow_fields = ['_ref']
...
class PxgridEndpoint(InfobloxObject):
    ...
    Fields:
    address: The pxgrid endpoint IPv4 Address or IPv6 Address or Fully-
        Qualified Domain Name (FQDN)
    client_certificate_subject: The Cisco ISE client certificate
        subject.
    client_certificate_token: The token returned by the uploadinit
    ...
    client_certificate_valid_from: The pxgrid endpoint client
        certificate valid from.
    client_certificate_valid_to: The pxgrid endpoint client certificate
        valid to.
    comment: The Cisco ISE endpoint descriptive comment.
    disable: Determines whether a Cisco ISE endpoint is disabled or not.
        When this is set to False, the Cisco ISE endpoint is enabled.
    ...
    publish_settings: The Cisco ISE publish settings.
    subscribe_settings: The Cisco ISE subscribe settings.
    template_instance: The Pxgrid template instance. You cannot change
        the parameters of the pxgrid endpoint template instance.
    timeout: The timeout of session management (in seconds).
    vendor_identifier: The vendor identifier.
    wapi_user_name: The user name for WAPI integration.
    wapi_user_password: The user password for WAPI integration.
