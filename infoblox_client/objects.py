...
class GridDns(InfobloxObject):
    ...
    Fields:
        ...
        enable_dns_health_check: Determines if the DNS health check is
            enabled or not.
        enable_dtc_dns_fall_through: Determines whether to enable the
            DTC to DNS fall-through or not.
...
class MemberDns(InfobloxObject):
    ...
    Fields:
        ...
        lan1_ipv6_ipsd: The IP space discriminator for IPv6 LAN1
            interface.
        lan2_ipsd: The IP space discriminator for LAN2 interface.
        lan2_ipv6_ipsd: The IP space discriminator for IPv6 LAN2
            interface.
        ...
        mgmt_ipv6_ipsd: The IP space discriminator for IPv6 MGMT
            interface.
...
class ParentalcontrolSubscriber(InfobloxObject):
    ...
    Fields:
        ...
        enable_parental_control: Determines if parental control is
            enabled.
        ident: Category content authorization string per customer for
            remote RD lookup and category access.
